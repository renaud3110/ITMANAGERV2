...
<div class="page-header">
    <div class="page-title">
        ...
        <p class="page-description">Ajouter un nouveau domaine à gérer</p>
    </div>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       value="<?= htmlspecialchars($_POST['domain_name'] ?? '') ?>"
                       required>
            ...
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       value="<?= htmlspecialchars($_POST['hosting_provider'] ?? '') ?>">
