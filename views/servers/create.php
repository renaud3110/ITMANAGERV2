<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Nouveau Serveur</h1>
            ...
            <form method="POST">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="type" name="type" required>
                                <option value="Physique" <?= ($_POST['type'] ?? '') === 'Physique' ? 'selected' : '' ?>>Physique</option>
                                <option value="Virtuel" <?= ($_POST['type'] ?? '') === 'Virtuel' ? 'selected' : '' ?>>Virtuel</option>
                            </select>
                        </div>
                    </div>
                </div>
                            ...
                            <select class="form-control" id="site_id" name="site_id">
                                ...
                                <?php foreach ($sites as $site): ?>
                                    <option value="<?= $site['id'] ?>" 
                                            <?= ($_POST['site_id'] ?? '') == $site['id'] ? 'selected' : '' ?>>
                            ...
                            <select class="form-control" id="model_id" name="model_id">
                                ...
                                <?php foreach ($models as $model): ?>
                                    <option value="<?= $model['id'] ?>" 
                                            <?= ($_POST['model_id'] ?? '') == $model['id'] ? 'selected' : '' ?>>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="processor_model" name="processor_model" 
                                   value="<?= htmlspecialchars($_POST['processor_model'] ?? '') ?>">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="ram_total_gb" name="ram_total_gb" 
                                   value="<?= htmlspecialchars($_POST['ram_total_gb'] ?? '') ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" class="form-control" id="ram_used_gb" name="ram_used_gb" 
                                   value="<?= htmlspecialchars($_POST['ram_used_gb'] ?? '') ?>">
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="operating_system_id" name="operating_system_id">
                                ...
                                <?php foreach ($operatingSystems as $os): ?>
                                    <option value="<?= $os['id'] ?>" 
                                            <?= ($_POST['operating_system_id'] ?? '') == $os['id'] ? 'selected' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" id="ip_address_id" name="ip_address_id">
                                ...
                                <?php foreach ($ipAddresses as $ip): ?>
                                    <option value="<?= $ip['id'] ?>" 
                                            <?= ($_POST['ip_address_id'] ?? '') == $ip['id'] ? 'selected' : '' ?>>
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save"></i> Créer le Serveur
                    </button>
                    <a href="?page=servers" class="btn btn-secondary">Annuler</a>
                </div>
            </form>
        </div>
    </div>
