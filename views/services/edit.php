...
<div class="page-header">
    <div>
        ...
        <p class="page-subtitle">Modifier les informations du service "<?= htmlspecialchars($service['nom']) ?>"</p>
    </div>
        ...
        <form method="POST" class="service-form">
            <div class="form-group">
                ...
                <input type="text" 
                       ...
                       value="<?= htmlspecialchars($_POST['nom'] ?? $service['nom']) ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <textarea id="description" 
                          ...
                          class="form-control" 
                          rows="3"
                          placeholder="Description optionnelle du service"><?= htmlspecialchars($_POST['description'] ?? $service['description']) ?></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="logo-input-group">
                    <input type="text" 
                           ...
                           value="<?= htmlspecialchars($_POST['logo'] ?? $service['logo']) ?>"
